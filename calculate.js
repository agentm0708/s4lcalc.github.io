...
function calculate() {
  ...
  document
    ...
    .forEach(
      (div) =>
        (div.textContent = "$ " + (Math.round(f75 * 10) / 10).toLocaleString())
    );
  ...
  document
    ...
    .forEach(
      (div) =>
        (div.textContent = "$ " + (Math.round(f83 * 10) / 10).toLocaleString())
    );
  ...
  document
    ...
    .forEach(
      (div) =>
        (div.textContent = "$ " + (Math.round(f92 * 10) / 10).toLocaleString())
    );
  ...
  document
    ...
    .forEach(
      (div) =>
        (div.textContent = "$ " + (Math.round(f101 * 10) / 10).toLocaleString())
    );
  ...
  document
    ...
    .forEach(
      (div) =>
        (div.textContent = "$ " + (Math.round(f151 * 10) / 10).toLocaleString())
    );

  a152 = a93 + d147 * f146;
  document.getElementById("a152").innerText = a152;

  l152 = l93 + d147 * f147 * f146;
  document.getElementById("l152").innerText = l152;

  //

  // Total Summary
  k71 = f75 + f83 + f92 + f101;
  document
    .querySelectorAll(".k71")
    .forEach(
      (div) =>
        (div.textContent = "$ " + (Math.round(k71 * 10) / 10).toLocaleString())
    );
}
